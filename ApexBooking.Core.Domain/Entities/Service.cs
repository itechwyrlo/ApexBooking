...
public class Service : IAggregateRoot, ITenantEntity
{
        ...
        int bufferAfterMinutes = 0)
    {
        ...
        var service = new Service(tenantId, name, description, durationMinutes, bufferBeforeMinutes, bufferAfterMinutes, price, currencyCode.ToUpperInvariant());
    ...
    public static void ValidateBookingWindow(DateTime scheduledUtc, DateTime nowUtc, int minHours, int maxDays)
    {
