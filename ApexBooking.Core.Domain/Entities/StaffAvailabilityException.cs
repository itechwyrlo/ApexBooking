...
/// </summary>
public class StaffAvailabilityException : ITenantEntity
{
    public StaffAvailabilityExceptionId StaffAvailabilityExceptionId { get; private set; } = default!;
    ...
    protected StaffAvailabilityException() { }

    private StaffAvailabilityException(
        StaffId staffId,
        TenantId tenantId,
        ...
        string? note)
    {
        StaffAvailabilityExceptionId = new StaffAvailabilityExceptionId(Guid.NewGuid());
        StaffId = staffId;
        TenantId = tenantId;
    ...
    internal static StaffAvailabilityException Create(
        StaffId staffId,
        TenantId tenantId,
        DateOnly exceptionDate,
        ExceptionType exceptionType,
        ...
        string? note)
    {
        ...
        return new StaffAvailabilityException(staffId, tenantId, exceptionDate, exceptionType, startTime, endTime, note);
    }
