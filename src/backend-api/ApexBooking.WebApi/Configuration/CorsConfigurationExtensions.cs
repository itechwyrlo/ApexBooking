...
public static class CorsConfigurationExtensions
{
        ...
        IWebHostEnvironment environment)
    {
        ...
        services.AddCors(options =>
        {
            ...
            {
                // Default development origin: the Vite dev server. Tenant identity now travels as
                // a path slug (not a Host-header subdomain), so anonymous and authenticated traffic
                // both originate from this same flat SPA origin.
