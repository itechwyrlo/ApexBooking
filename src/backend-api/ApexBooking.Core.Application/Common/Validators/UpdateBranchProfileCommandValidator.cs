...
/// <summary>
/// Validator for UpdateBranchProfileCommand - validates branch name, time zone, and address
/// </summary>
public class UpdateBranchProfileCommandValidator : AbstractValidator<UpdateBranchProfileCommand>
{
    ...
    public UpdateBranchProfileCommandValidator(IPsgcReferenceService psgcReferenceService)
    {
