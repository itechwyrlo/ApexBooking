...
{
    internal sealed class RejectTenantRequestHandler : ICommandHandler<RejectTenantRequestCommand>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IUserContextService _userContext;

        public RejectTenantRequestHandler(
        ...
        public async Task Handle(RejectTenantRequestCommand command, CancellationToken cancellationToken)
        {
            ...
            request.Reject(currentUserId, command.Reason);
