...
using ApexBooking.Infrastructure.ExternalServices.Push;
...
namespace ApexBooking.Infrastructure.Dependency
{
    public static class InfrastructureDependencies
    {
        public static IServiceCollection AddInfrastructureService(this IServiceCollection service, IConfiguration config)
        {
            ...
            service.Configure<FirebaseSettings>(config.GetSection("Firebase"));
            service.AddScoped<IPushNotificationService, FcmPushNotificationService>();
