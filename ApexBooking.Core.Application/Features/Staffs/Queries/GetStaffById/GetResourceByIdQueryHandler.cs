...
{
    internal sealed class GetStaffByIdQueryHandler : IQueryHandler<GetStaffByIdQuery, StaffDto>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IUserContextService _contextService;

        public GetStaffByIdQueryHandler(IUnitOfWork unitOfWork, IUserContextService contextService)
        {
            _unitOfWork = unitOfWork;
            _contextService = contextService;
        }

        public async Task<StaffDto> Handle(GetStaffByIdQuery query, CancellationToken cancellationToken)
        {
