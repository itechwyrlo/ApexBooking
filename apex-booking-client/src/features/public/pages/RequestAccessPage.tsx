          ...
          <div className="request-card">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                ...
                />
                <div className="form-text small text-muted mt-1">The name of your business or organization</div>
              </div>
              <div className="mb-3">
                ...
                />
                <div className="form-text small text-muted mt-1">Your first and last name</div>
              </div>
              <div className="mb-3">
                ...
                />
                <div className="form-text small text-muted mt-1">We'll contact you at this address with setup instructions</div>
              </div>
              <div className="mb-3">
                ...
                />
                <div className="form-text small text-muted mt-1">Include your country code (e.g. +1 555 000 0000)</div>
              </div>
              <div className="mb-4">
                ...
                />
                <div className="form-text small text-muted mt-1">Briefly describe your business and how you plan to use ApexBooking</div>
              </div>
