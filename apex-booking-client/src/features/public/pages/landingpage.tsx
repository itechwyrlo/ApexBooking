            ...
            <div className="col-lg-6">
              ...
              <div className="d-flex flex-wrap gap-3">
                <button className="btn-apex-primary" onClick={() => navigate("/pricing")}>
                  See Plans <FontAwesomeIcon icon={faArrowRight} className="hero-cta-icon" />
                </button>
              ...
              <div className="hero-visual">
                ...
                <div className="mock-confirm-bar">
                  ...
                  <div className="mock-confirm-badge">
                    <FontAwesomeIcon icon={faCheck} className="me-2" />Booked
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="reveal">
            ...
            <div className="d-flex gap-3 justify-content-center flex-wrap">
              <button className="btn-cta-primary" onClick={() => navigate("/pricing")}>
                View Pricing <FontAwesomeIcon icon={faArrowRight} className="hero-cta-icon" />
              </button>
        ...
        <div className="container">
          ...
          <div className="footer-bottom">
            ...
            <div className="d-flex gap-3">
              <a href="/" className="footer-social"><FontAwesomeIcon icon={faTwitter} /></a>
              <a href="/" className="footer-social"><FontAwesomeIcon icon={faLinkedin} /></a>
              <a href="/" className="footer-social"><FontAwesomeIcon icon={faGithub} /></a>
            </div>
          </div>
        </div>
      </footer>
