              ...
              {settingsLoading && !settings ? (
                ...
                <>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">Minimum hours before a slot when customers can book (0 = no minimum)</div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">Maximum number of days ahead a customer can make a booking</div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">Hours before the appointment after which cancellations are considered late (0 = no cutoff)</div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">How many hours before the appointment to send a reminder to the customer</div>
                  </div>
                        ...
                        <div className="row g-2">
                          ...
                          <div className="col-12 col-sm-7">
                            ...
                            <div className="form-text small text-muted mt-1">
                              {policyForm.depositType === 'FixedAmount'
                                ? 'Fixed amount to collect at booking'
              ...
              {profileLoading && !profile ? (
                ...
                <>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">Street number and street name</div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">Apartment, suite, unit, or floor (optional)</div>
                  </div>
                  ...
                  <div className="row g-2 mb-3">
                    <div className="col-12 col-sm-6">
                      ...
                      />
                      <div className="form-text small text-muted mt-1">ZIP or postal code</div>
                    </div>
                    <div className="col-12 col-sm-6">
                      ...
                      />
                      <div className="form-text small text-muted mt-1">2-letter ISO country code (e.g. PH, US, GB)</div>
                    </div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">Public contact email visible to customers</div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">Public contact phone visible to customers</div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">Your organization's public website URL</div>
                  </div>
