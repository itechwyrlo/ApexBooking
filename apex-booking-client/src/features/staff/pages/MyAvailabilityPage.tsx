...
const MyAvailabilityPage: React.FC = () => {
  const { getMyProfile, profile, isLoading: profileLoading, error: profileError } = useMyProfile();
  ...
  return <MyAvailabilityContent staffId={profile.id} />;
};

const MyAvailabilityContent: React.FC<{ staffId: string }> = ({ staffId }) => {
  const {
  ...
  return (
    <div className="container-fluid px-3 px-md-4 py-4">
      <div className="row mb-4 align-items-center">
        <div className="col">
          <h5 className="fw-bold mb-0">My Availability</h5>
          <small className="text-muted">Set your weekly schedule and date-specific exceptions.</small>
        </div>
      </div>
      ...
      <div className="card border-0 shadow-sm mb-4">
        <div className="card-header bg-white border-bottom py-3">
          ...
          <div className="text-muted small mt-1">
            Defines your recurring working hours. This is a full replacement on save.
          </div>
        </div>
      ...
      <div className="card border-0 shadow-sm">
        <div className="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
          <div>
            ...
            <div className="text-muted small mt-1">Override your weekly schedule for specific dates.</div>
          </div>
          <Button
            variant="secondary"
            size="sm"
