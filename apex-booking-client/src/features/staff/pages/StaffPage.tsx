...
const staffFormSchema: ModelSchema<CreateStaffRequest>[] = [
  { key: "firstName", label: "First Name", type: "string", required: true, helpText: "Letters, spaces, hyphens, and apostrophes only" },
  { key: "lastName", label: "Last Name", type: "string", required: true, helpText: "Letters, spaces, hyphens, and apostrophes only" },
  { key: "email", label: "Email", type: "string", required: false, helpText: "Used to send the account invitation to this staff member" },
  { key: "contactNumber", label: "Contact", type: "phone", required: false, helpText: "Include country code (e.g. +1 555 000 0000)" },
  { key: "capacity", label: "Capacity", type: "number", required: true, helpText: "Maximum simultaneous bookings this staff member can handle (minimum 1)" },
