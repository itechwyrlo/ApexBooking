...
const CustomerBookingsPage: React.FC = () => {
  const { customerBookings, isLoading, error, clearError, getCustomerBooking, cancel } =
    useBookings();

  const [showConfirm, setShowConfirm] = useState(false);
  const [targetBooking, setTargetBooking] = useState<CustomerBooking | null>(null);
  ...
  const openCancel = (booking: CustomerBooking) => {
  ...
  const handleCancel = async () => {
    ...
    const ok = await cancel(targetBooking.bookingId, getCustomerBooking);
    if (ok) {
...
// const CustomerBookingsPage: React.FC = () => {
//   const { bookings, isLoading, error, clearError, getCustomerBooking, cancel } =
//     useBookings();
...
//                 <thead className="table-light">
//                   <tr>
//                     <th className="ps-4 fw-semibold small text-muted">
//                       Reference
//                     </th>
//                     <th className="fw-semibold small text-muted">Service</th>
//                     <th className="fw-semibold small text-muted">Resource</th>
...
//                     <th className="fw-semibold small text-muted">Status</th>
//                     <th className="fw-semibold small text-muted">Price</th>
//                     <th className="fw-semibold small text-muted">
//                       payment status
//                     </th>
//                     <th className="fw-semibold small text-muted text-end pe-4">
//                       Actions
//                     </th>
//                   </tr>
//                 </thead>
...
//                       </td>
//                       <td className="text-muted small">
//                         {/* Adjusted to match JSON property names */}
//                         ({b.startTime} -{" "}
//                         {b.endTime})
//                       </td>
//                       <td>
//                         <span
//                           className={`badge ${getStatusBadgeClass(b.status)}`}
//                         >
//                           {BOOKING_STATUS_LABELS[b.status]}
//                         </span>
//                       </td>
//                       {/* Price Column */}
//                       <td className="text-muted small">
//                         {b.priceSnapshot} {b.currencyCode}
//                       </td>
//                       {/* Payment Status Column */}
//                       <td>
//                         <span className="badge bg-light text-dark border">
//                           {b.status === "PendingPayment" ? "Unpaid" : "Paid"}
//                         </span>
//                       </td>
//                       <td className="text-end pe-4">
//                         {b.status !== "Cancelled" && (
