              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  <Input
                    ...
                    required
                  />
                  <div className="form-text small text-muted mt-1">Enter your first and last name</div>
                </div>
                <div className="mb-3">
                  <Input
                    label="Email address"
                    ...
                    required
                  />
                  <div className="form-text small text-muted mt-1">Used to sign in and receive booking notifications</div>
                </div>
                <div className="mb-3">
                  <PhoneField
                    label="Phone"
                ...
                <div className="mb-4">
                  <Input
                    ...
                    showToggle
                  />
                  <div className="form-text small text-muted mt-1">At least 8 characters</div>
                </div>
