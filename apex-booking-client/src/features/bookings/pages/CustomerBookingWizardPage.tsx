...
import { faCheck, faClock, faCreditCard } from "@fortawesome/free-solid-svg-icons";
...
const CustomerBookingWizardPage: React.FC = () => {
  ...
  // Compute min/max dates from tenant settings (mirrors backend slot window calculation)
  const { minDate, maxDate } = useMemo(() => {
    ...
    const maxDateTime = new Date(
      tenantNow.getTime() + tenantData.maxAdvanceBookingDays * 24 * 60 * 60 * 1000,
    );
      ...
      <div className="min-vh-100 bg-light d-flex align-items-center justify-content-center p-3">
        <div className="card border-0 shadow-sm p-4 text-center wizard-result-card">
          <div className="wizard-icon-circle rounded-circle bg-info bg-opacity-10 d-flex align-items-center justify-content-center mx-auto mb-3">
            <FontAwesomeIcon icon={faClock} size="xl" className="text-info" />
          </div>
      ...
      <div className="min-vh-100 bg-light d-flex align-items-center justify-content-center p-3">
        <div className="card border-0 shadow-sm p-4 text-center wizard-result-card">
          <div className="wizard-icon-circle rounded-circle bg-warning bg-opacity-10 d-flex align-items-center justify-content-center mx-auto mb-3">
            <FontAwesomeIcon icon={faCreditCard} size="xl" className="text-warning" />
          </div>
