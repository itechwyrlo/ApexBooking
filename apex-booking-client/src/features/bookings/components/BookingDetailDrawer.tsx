...
import { faXmark, faCalendarAlt, faClock, faUser, faEnvelope, faPhone, faTag } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="booking-drawer">
        ...
        <div className="flex-grow-1 overflow-auto p-4">
          ...
          <div className="d-flex align-items-center gap-2 mb-3">
            <FontAwesomeIcon icon={faCalendarAlt} className="booking-drawer-icon text-muted" />
            <span className="small">{formatDate(booking.scheduledDate)}</span>
          </div>

          <div className="d-flex align-items-center gap-2 mb-3">
            <FontAwesomeIcon icon={faClock} className="booking-drawer-icon text-muted" />
          ...
          {booking.resourceName && (
            <div className="d-flex align-items-center gap-2 mb-3">
              <FontAwesomeIcon icon={faUser} className="booking-drawer-icon text-muted" />
          ...
          {booking.guest?.email && (
            <div className="d-flex align-items-center gap-2 mb-3">
              <FontAwesomeIcon icon={faEnvelope} className="booking-drawer-icon text-muted" />
          ...
          {booking.guest?.phone && (
            <div className="d-flex align-items-center gap-2 mb-3">
              <FontAwesomeIcon icon={faPhone} className="booking-drawer-icon text-muted" />
          ...
          {booking.priceSnapshot > 0 && (
            <div className="d-flex align-items-center gap-2 mb-3">
              <FontAwesomeIcon icon={faTag} className="booking-drawer-icon text-muted" />
