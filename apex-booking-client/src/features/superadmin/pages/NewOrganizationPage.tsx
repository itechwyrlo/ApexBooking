          ...
          <div className="card border-0 shadow-sm">
            ...
            <div className="card-body p-4">
              <div className="mb-3">
                ...
                />
                <div className="form-text small text-muted mt-1">The full name of the organization</div>
              </div>
          ...
          <div className="card border-0 shadow-sm">
            ...
            <div className="card-body p-4">
              <div className="mb-3">
                ...
                />
                <div className="form-text small text-muted mt-1">First and last name of the admin user</div>
              </div>
              ...
              <div className="mb-3">
                ...
                />
                <div className="form-text small text-muted mt-1">Used for the admin account login</div>
              </div>
              ...
              <div className="mb-3">
                ...
                />
                <div className="form-text small text-muted mt-1">Include country code (e.g. +1234567890)</div>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="form-text small text-muted mt-1">At least 8 characters. The admin will be prompted to change this on first login.</div>
              </div>
            </div>
          </div>
        </div>
