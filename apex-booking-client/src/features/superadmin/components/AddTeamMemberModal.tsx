...
import { faPlus, faUserCheck, faEnvelope } from '@fortawesome/free-solid-svg-icons';
              ...
              {tab === 'create' ? (
                <>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">First and last name of the team member</div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">The invitation will be sent to this address</div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-text small text-muted mt-1">Determines what the team member can access and manage</div>
                  </div>
                </>
              ) : (
                <>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    <div className="form-text small text-muted mt-1">Must match the email of an existing user in this organization</div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-text small text-muted mt-1">The user's existing role will be replaced with this selection</div>
                  </div>
                </>
              )}
            </div>
